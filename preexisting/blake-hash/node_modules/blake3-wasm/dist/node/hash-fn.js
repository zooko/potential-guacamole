...
const hash_instance_1 = require("./hash-instance");
/**
 * Returns a blake3 hash of the input.
 */
function hash(input, { length = blake3_internal_1.defaultHashLength } = {}) {
    return Buffer.from((0, blake3_internal_1.hashOneShot)((0, blake3_internal_1.inputToArray)(input), length));
}
exports.hash = hash;
/**
...
function deriveKey(context, material, { length = blake3_internal_1.defaultHashLength } = {}) {
    const derive = (0, hash_instance_1.createDeriveKey)(context);
...
function keyedHash(key, input, { length = blake3_internal_1.defaultHashLength } = {}) {
    const keyed = (0, hash_instance_1.createKeyed)(key);
